...
type ReadDirPlusOp struct {
	...
	//
	// The output data should consist of a sequence of FUSE directory entries in
	// the format generated by fuse_add_direntry_plus (http://shortn/_Ajko0QI5QW),
	// which is consumed by parse_dirplusfile (http://shortn/_PH3M1gznVn). Use
	// fuseutil.WriteDirentPlus to generate this data.
	Dst []byte
